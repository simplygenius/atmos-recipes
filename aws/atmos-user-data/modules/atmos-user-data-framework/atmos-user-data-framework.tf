...
locals {
  ...
  partial_user_data_files = concat(
    local.implicit_user_data_files,
    var.additional_user_data_files,
  )
  user_data_file_count = length(local.partial_user_data_files) + 1
  user_data_files      = concat(local.partial_user_data_files, [local.env_user_data_file])
}
